...
st.markdown("<h6 style = 'top_margin: 0rem; color: #F2921D'>Built by Oluwayomi Rosemary</h6>", unsafe_allow_html = True)

# Add an image to the page
st.image('pngwing.com (11).png', caption = 'FACE DETECTOR', width = 400)
